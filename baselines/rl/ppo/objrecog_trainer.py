...
@baseline_registry.register_trainer(name="objrecog")
class ObjRecogTrainer(BaseRLTrainer):
    ...
    def _setup_actor_critic_agent(self, ppo_cfg: Config) -> None:
        ...
        self.agent = (DDPPO if self._is_distributed else ObjRecogPPO)(
    ...
    def _init_train(self):
        ...
        self.rollouts = MapRolloutStorage(
            ppo_cfg.num_steps,
            self.envs.num_envs,
            obs_space,
