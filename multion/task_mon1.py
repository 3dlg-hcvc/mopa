...
class MultiObjectNavDatasetV1(PointNavDatasetV1):
    ...
    def from_json(
        ...
        if "category_to_task_category_id" in deserialized:
            ...
            #self.category_to_task_category_id = {k: v+1 for k, v in self.category_to_task_category_id.items()} # for hm3d
            self.category_to_task_category_id = {k: v+5000 for k, v in self.category_to_task_category_id.items()} # for mp3d
